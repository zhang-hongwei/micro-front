...
export function getAppChanges() {
    const appsToUnload = [], // apps that are not active and should be unloaded
        appsToUnmount = [], // apps that are not active and should be unmounted
        appsToLoad = [], // apps that are not active and should be loaded
        appsToMount = []; // apps that are not active and should be mounted
    ...
    apps.forEach((app) => {
        ...
        console.log('log=1=1=1======>>>', apps, shouldBeActive(app), appShouldBeActive)
        switch (app.status) {
            case LOAD_ERROR:
